...
<body>
    ...
    <div class="box">
        ...
        <form name="menuForm">
            <input type="checkbox" name="makanan" value="10000" onclick="hitungTotal()"> Nasi Goreng (15.000)<br>
            <input type="checkbox" name="makanan" value="8000" onclick="hitungTotal()"> Mie Ayam (10.000)<br>
